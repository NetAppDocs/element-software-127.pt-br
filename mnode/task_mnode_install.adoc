...
*** *--storage_mvip (-sm) [Endereço MVIP]*: O endereço IP de gerenciamento virtual (MVIP) do cluster de armazenamento que executa o software Element. Configure o nó de gerenciamento com o mesmo cluster de armazenamento que você usou durante link:task_mnode_recover.html#configure-time-sync["Configuração de servidores NTP"].
