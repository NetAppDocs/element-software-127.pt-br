...
* link:task_system_manage_fips_identify_nodes_ready_for_fips_drives.html["Identificar se os nós estão prontos para o recurso unidades FIPS"]
...
* link:task_system_manage_fips_troubleshoot_the_fips_drive_feature.html["Solucionar problemas do recurso da unidade FIPS"]
